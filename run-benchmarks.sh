...
$BENCHMARK $ENDPOINT_URL $(dart benchmark/ideal_hashmap_based_injector_benchmark.dart)
...
mkdir -p out
dart2js --minify benchmark/no_injector_benchmark.dart -o out/no_injector_benchmark.dart.js
dart2js --minify benchmark/ideal_hashmap_based_injector_benchmark.dart -o out/ideal_hashmap_based_injector_benchmark.dart.js
...
$BENCHMARK $ENDPOINT_URL $(node out/ideal_hashmap_based_injector_benchmark.dart.js)
