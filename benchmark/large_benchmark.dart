...
class GetFromRoot extends LargeBenchmark {
  GetFromRoot()
      : super('FromRoot', (m) => new StaticInjector(modules: m, typeFactories: f.typeFactories));
...
class GetFromLeaf extends LargeBenchmark {
  GetFromLeaf()
      : super('FromLeaf', (m) => new StaticInjector(modules: m, typeFactories: f.typeFactories));
